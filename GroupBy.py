...
print(grouped3)
max_temp_grouped = df.loc[(df['Year'] >= 1995) & (df['Year'] <= 2000)].groupby(['Year', 'Season','Month'])['Temperature'].max()
print(max_temp_grouped)
temp_1 = df.loc[(df["Month"] >= 8) & (df["Year"] == 1995), ["Year","Month", "Temperature", "Salinity"]]
